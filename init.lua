...
core.settings = {
    ...
    police_jobs = settings.police_jobs or { "police" },
    on_duty_only_alerts = settings.on_duty_only_alerts or false,
    required_police = settings.required_police or 0,
    on_duty_only_required = settings.on_duty_only_required or false,
